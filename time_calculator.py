def add_time(start, duration, day_of_week=False):
    ...
    days_of_the_week_index = {"monday": 0, "tuesday": 1, "wednesday": 2, "thrusday": 3, "friday": 4, "saturday": 5, "sunday": 6}

    days_of_the_week_array = ["Monday", "Tuesday", "Wednesday", "Thrusday", "Friday", "Saturday", "Sunday"]

    duration_tuple = duration.partition(":")
    duration_hours= int(duration_tuple[0])
    duartion_minutes = int(duration_tuple[2])
    ...
    end_minutes = start_minutes + duartion_minutes
    if(end_minutes >= 60):
      start_hours += 1
